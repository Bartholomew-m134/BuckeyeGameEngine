...
{
    [TestClass]
    public class BigMarioSolidBlockCollisionTests
    {
        Game1 game = new Game1();

        [TestMethod]
        public void BigMarioSolidBlockLeftSideCollisionTest()
        {
        ...
        [TestMethod]
        public void BigMarioSolidBlockRightSideCollisionTest()
        {
            MarioInstance testMario = new MarioInstance(game);
            MarioInstance expectedMario = new MarioInstance(game);
            expectedMario.VectorCoordinates = new Vector2(12, 0);
        ...
        [TestMethod]
        public void BigMarioSolidBlockTopSideCollisionTest()
        {
            MarioInstance testMario = new MarioInstance(game);
            MarioInstance expectedMario = new MarioInstance(game);
        ...
        [TestMethod]
        public void BigMarioSolidBlockBottomSideCollisionTest()
        {
            MarioInstance testMario = new MarioInstance(game);
            MarioInstance expectedMario = new MarioInstance(game);
            expectedMario.VectorCoordinates = new Vector2(0,15);
