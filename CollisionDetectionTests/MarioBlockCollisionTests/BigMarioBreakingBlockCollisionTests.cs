...
{
    [TestClass]
    public class BigMarioBreakingBlockCollisionTests
    {
        Game1 game = new Game1();

        [TestMethod]
        public void BigMarioBreakingBlockLeftSideCollisionTest()
        {
        ...
        [TestMethod]
        public void BigMarioBreakingBlockRightSideCollisionTest()
        {
            MarioInstance testMario = new MarioInstance(game);
            MarioInstance expectedMario = new MarioInstance(game);
        ...
        [TestMethod]
        public void BigMarioBreakingBlockTopSideCollisionTest()
        {
            MarioInstance testMario = new MarioInstance(game);
            MarioInstance expectedMario = new MarioInstance(game);
        ...
        [TestMethod]
        public void BigMarioBreakingBlockBottomSideCollisionTest()
        {
            MarioInstance testMario = new MarioInstance(game);
            MarioInstance expectedMario = new MarioInstance(game);
