...
{
    public class WolverineChuckCharginRightSprite : ISprite
    {
        private Texture2D spriteSheet;
        private int currentFrame = 0;
        private Vector2[] animationFrameDimensions = new Vector2[2] { WolverineEnemyConstant.CHUCK_RIGHT_FRAME_1_DIMENSIONS, WolverineEnemyConstant.CHUCK_RIGHT_FRAME_2_DIMENSIONS };
        private Vector2[] animationFrameLocation = new Vector2[2] { WolverineEnemyConstant.CHUCK_RIGHT_FRAME_1_SOURCE, WolverineEnemyConstant.CHUCK_RIGHT_FRAME_2_SOURCE };


        public WolverineChuckCharginRightSprite(Texture2D texture)
        {
            spriteSheet = texture;
        }
