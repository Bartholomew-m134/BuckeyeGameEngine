...
{
    public class GiantVerticalStoneWallSprite : ISprite
    {
        private Texture2D texture;
        private const int xLocation = 7;
        private const int yLocation = 5;
        private const int xDimension = 16;
        private const int yDimension = 192;
        private Rectangle sourceRectangle = new Rectangle(xLocation, yLocation, xDimension, yDimension);

        public GiantVerticalStoneWallSprite(Texture2D texture)
        {
