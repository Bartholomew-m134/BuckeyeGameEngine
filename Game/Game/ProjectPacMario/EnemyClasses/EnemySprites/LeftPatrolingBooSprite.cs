...
{
    public class LeftPatrolingBooSprite : ISprite
    {
        private Texture2D spriteSheet;
        private int starDrawCounter;
        public LeftPatrolingBooSprite(Texture2D spriteSheet)
        {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)PacMarioSpriteConstants.LEFT_BOO_SOURCE.X, (int)PacMarioSpriteConstants.LEFT_BOO_SOURCE.Y,
