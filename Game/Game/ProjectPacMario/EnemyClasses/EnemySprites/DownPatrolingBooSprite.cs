...
{
    public class DownPatrolingBooSprite : ISprite
    {
        private Texture2D spriteSheet;
        private int starDrawCounter;
        public DownPatrolingBooSprite(Texture2D spriteSheet)
        {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)PacMarioSpriteConstants.DOWN_BOO_SOURCE.X, (int)PacMarioSpriteConstants.DOWN_BOO_SOURCE.Y,
