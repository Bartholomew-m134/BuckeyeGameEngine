...
{
    public class RightPatrolingBooSprite : ISprite
    {
        private Texture2D spriteSheet;
        private int starDrawCounter;
        public RightPatrolingBooSprite(Texture2D spriteSheet)
        {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)PacMarioSpriteConstants.RIGHT_BOO_SOURCE.X, (int)PacMarioSpriteConstants.RIGHT_BOO_SOURCE.Y,
