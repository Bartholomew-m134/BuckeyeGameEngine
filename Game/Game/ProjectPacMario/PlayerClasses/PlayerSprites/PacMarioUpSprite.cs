...
{
    public class PacMarioUpSprite : IMarioSprite
    {
        ...
        public PacMarioUpSprite(Texture2D spriteSheet)
        {
        ...
        public void Update()
        {
            ...
            if (updateDelay == MarioSpriteConstants.RUNNINGUPDATEDELAY && openOrClosed){
                ...
                openOrClosed = false;
                currentSource = PacMarioSpriteConstants.MOUTH_OPEN_UP_SOURCE;
            }
            else if (updateDelay == MarioSpriteConstants.RUNNINGUPDATEDELAY && !openOrClosed)
            {
                updateDelay = MarioSpriteConstants.RESETTOZERO;
                openOrClosed = true;
                currentSource = PacMarioSpriteConstants.MOUTH_CLOSED_UP_SOURCE;
            }
        }
