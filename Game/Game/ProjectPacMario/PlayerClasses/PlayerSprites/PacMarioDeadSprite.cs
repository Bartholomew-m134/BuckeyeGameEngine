...
{
    public class PacMarioDeadSprite : IMarioSprite
    {
        private Texture2D spriteSheet;
        private int starDrawCounter;
        public PacMarioDeadSprite(Texture2D spriteSheet)
        {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)PacMarioSpriteConstants.DEAD_BOO_SOURCE.X, (int)PacMarioSpriteConstants.DEAD_BOO_SOURCE.Y,
