...
{
    public class PacMarioRightSprite : IMarioSprite
    {
        ...
        public PacMarioRightSprite(Texture2D spriteSheet)
        {
        ...
        public void Update()
        {
            ...
            if (updateDelay == MarioSpriteConstants.RUNNINGUPDATEDELAY && openOrClosed){
                ...
                openOrClosed = false;
                currentSource = PacMarioSpriteConstants.MOUTH_OPEN_RIGHT_SOURCE;
            }
            else if (updateDelay == MarioSpriteConstants.RUNNINGUPDATEDELAY && !openOrClosed)
            {
                updateDelay = MarioSpriteConstants.RESETTOZERO;
                openOrClosed = true;
                currentSource = PacMarioSpriteConstants.MOUTH_CLOSED_RIGHT_SOURCE;
            }
        }
