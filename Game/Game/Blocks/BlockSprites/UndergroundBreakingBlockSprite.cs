...
namespace Game.Blocks.BlockSprites
{
    public class UndergroundBreakingBlockSprite : ISprite
    {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)BlockSpriteConstants.UNDERGROUNDBREAKINGBLOCKSOURCE.X, (int)BlockSpriteConstants.UNDERGROUNDBREAKINGBLOCKSOURCE.Y,
