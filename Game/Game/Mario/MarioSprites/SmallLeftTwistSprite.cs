...
{
    public class SmallLeftTwistSprite : IMarioSprite
    {
        private int starDrawCounter;
        private Texture2D spriteSheet;
        public SmallLeftTwistSprite(Texture2D spriteSheet)
        {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)MarioSpriteConstants.SMALLLEFTTWISTSOURCE.X, (int)MarioSpriteConstants.SMALLLEFTTWISTSOURCE.Y,
                (int)MarioSpriteConstants.SMALLLEFTTWISTDIMENSIONS.X, (int)MarioSpriteConstants.SMALLLEFTTWISTDIMENSIONS.Y);
        ...
        {
            get { return new Vector2((int)MarioSpriteConstants.SMALLLEFTTWISTDIMENSIONS.X, (int)MarioSpriteConstants.SMALLLEFTTWISTDIMENSIONS.Y); }
        }
    }
}
