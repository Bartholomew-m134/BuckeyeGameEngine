...
{
    public class SmallRightTwistSprite : IMarioSprite
    {
        private int starDrawCounter;
        private Texture2D spriteSheet;
        public SmallRightTwistSprite(Texture2D spriteSheet)
        {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)MarioSpriteConstants.SMALLRIGHTTWISTSOURCE.X, (int)MarioSpriteConstants.SMALLRIGHTTWISTSOURCE.Y,
                (int)MarioSpriteConstants.SMALLRIGHTTWISTDIMENSIONS.X, (int)MarioSpriteConstants.SMALLRIGHTTWISTDIMENSIONS.Y);
        ...
        {
            get { return new Vector2((int)MarioSpriteConstants.SMALLRIGHTTWISTDIMENSIONS.X, (int)MarioSpriteConstants.SMALLRIGHTTWISTDIMENSIONS.Y); }
        }
    }
}
