...
{
    public class NormalRightJumpingMarioSprite : IMarioSprite
    {
        private int starDrawCounter;
        private Texture2D spriteSheet;
        public NormalRightJumpingMarioSprite(Texture2D spriteSheet)
        {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)MarioSpriteConstants.NORMALRIGHTJUMPSOURCE.X, (int)MarioSpriteConstants.NORMALRIGHTJUMPSOURCE.Y,
                (int)MarioSpriteConstants.NORMALRIGHTJUMPDIMENSIONS.X, (int)MarioSpriteConstants.NORMALRIGHTJUMPDIMENSIONS.Y);
        ...
        {
            get { return new Vector2((int)MarioSpriteConstants.NORMALRIGHTJUMPDIMENSIONS.X, (int)MarioSpriteConstants.NORMALRIGHTJUMPDIMENSIONS.Y); }
        }
    }
}
