...
namespace Game.Mario.MarioSprites
{
    public class NormalRightCrouchingMarioSprite : IMarioSprite
    {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)MarioSpriteConstants.NORMALRIGHTCROUCHSOURCE.X, (int)MarioSpriteConstants.NORMALRIGHTCROUCHSOURCE.Y,
                (int)MarioSpriteConstants.NORMALRIGHTCROUCHDIMENSIONS.X, (int)MarioSpriteConstants.NORMALRIGHTCROUCHDIMENSIONS.Y);
        ...
        {
            get { return new Vector2((int)MarioSpriteConstants.NORMALRIGHTCROUCHDIMENSIONS.X, (int)MarioSpriteConstants.NORMALRIGHTCROUCHDIMENSIONS.Y); }
        }
    }
}
