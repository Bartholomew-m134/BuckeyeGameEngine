...
namespace Game.Mario.MarioSprites
{
    public class FireThrowLeftSprite : IMarioSprite
    {
        ...
        {
            Rectangle sourceRectangle = new Rectangle((int)MarioSpriteConstants.FIRETHROWLEFTSOURCE.X, (int)MarioSpriteConstants.FIRETHROWLEFTSOURCE.Y,
                (int)MarioSpriteConstants.FIRETHROWLEFTDIMENSIONS.X, (int)MarioSpriteConstants.FIRETHROWLEFTDIMENSIONS.Y);
        ...
        {
            get { return new Vector2((int)MarioSpriteConstants.FIRETHROWLEFTDIMENSIONS.X, (int)MarioSpriteConstants.FIRETHROWLEFTDIMENSIONS.Y); }
        }
    }
}
